...
function tabMenuLnk(){
	...
	$(".tab_wrap_lnk.anchor > li > a").off().on("click", function(){
		...
		$("html, body").animate({ scrollTop : $($(this).attr("href")).offset().top - topFixedOff}, 500);
	});
...
function closeLayer(obj){
	removeOverlay();
	$(".layer_wrap.active").removeClass("active").removeAttr("tabindex");
	//focus돌아오고 임시 클래스 삭제
