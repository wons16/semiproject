                ...
                ? function () {
                    ...
                    return n
                      ? t.isFunction(n[a]) && "_" !== a.charAt(0)
                        ? ((s = n[a].apply(n, h)),
                          s !== n && s !== e
                            ? ((l = s && s.jquery ? l.pushStack(s.get()) : s),
                              !1)
                            : void 0)
                        : t.error(
                            "no such method '" +
        ...
        switch (s) {
          ...
          case "intersect":
            return (
              ...
              h - t.helperProportions.width / 2 < d &&
        ...
        return (
          ...
          "disabled" === t
            ? (this.element.prop("disabled", !!e),
              void (e && this.buttonElement.removeClass("ui-state-focus")))
  ...
  (function (t, e) {
    ...
    t.extend(i.prototype, {
      ...
      parseDate: function (e, i, s) {
        ...
        if (
          ((r = this._daylightSavingAdjust(new Date(g, m - 1, v))),
      ...
      _generateHTML: function (t) {
        ...
        for (
          ...
          for (k = "", this.maxRows = 4, D = 0; D < q[1]; D++) {
            if (
            ...
            for (
              P += T + "</tr></thead><tbody>",
                ...
                this.maxRows = H,
                W = this._daylightSavingAdjust(new Date(te, Z, 1 - z)),
                E = 0;
              H > E;
              E++
            ) {
        ...
        return (
          ...
          (t._keyEvent = !1),
          (y =
            "<div class='hidden'>월이동:PageUp/PageDown, 일이동:Ctrl+방향키</div>" +
            y)
        );
      },
