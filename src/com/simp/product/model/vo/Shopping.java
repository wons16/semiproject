...
public class Shopping {
	...
	public Shopping(int productNo, String pdCategory, String productName, int productPrice, int stock,
	...
	public String toString() {
		return "Shopping [productNo=" + productNo + ", pdCategory=" + pdCategory + ", productName=" + productName
